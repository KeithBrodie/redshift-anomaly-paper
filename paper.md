...
Galaxy rotation curves, X-ray emission from hot gas, and gravitational lensing consistently show that galaxy halos have an isothermal density profile over a wide radial range:
...
Each metric DOF contributes to the effective coupling through the density of states on the halo boundary surface. On a 2-dimensional surface (the effective horizon associated with the halo boundary), the Fourier normalization factor is:

$$(2\pi)^2 = 4\pi^2$$

This is the standard 2D phase-space factor that appears in the Casimir energy density for modes confined to or normalized on a surface:
...
**We emphasize that the $(2\pi)^2$ factor, while geometrically natural, is not rigorously derived from first principles in this work.** It is motivated by the mode-counting geometry of the horizon surface but a complete derivation would require a non-perturbative calculation within the Jacobson (1995) thermodynamic framework. We return to this in Section 6.
...
| $N_{\text{DOF}}$ | $g$ | $\log_{10}(\alpha)$ | Deviation |
|:-:|:-:|:-:|:-:|
| 4 | 157.91 | 0.10866 | $3.9\sigma$ |
| 5 | 197.39 | 0.09717 | $1.6\sigma$ |
| **6** | **236.87** | **0.08870** | **$0.06\sigma$** |
...
### 6.5 Why the Period Cannot Be Accidental
